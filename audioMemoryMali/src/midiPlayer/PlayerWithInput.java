...
public class PlayerWithInput {
		...
		public static void main(String[] args) {
			...
			mini.spielenMitInput(10);
		}


		
			//Note abspielen, mit der Variablen int length alks Notenlänge, Tonhöhe folgt noch
 ...
 * channel -  the channel associated with the message		CHANNEL
 * data1 -   the first data byte    						TONHOEHE
 * data2 -    the second data byte  						TONLAUTSTAERKE 
 *  */
			...
			//separate Funktion, welche mit mit "on" den Anfangsbefehl entgegennimmt und mit "off" den Abschlussbefehl des Tons
